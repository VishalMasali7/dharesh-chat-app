const socket = io() // call io, connect to server
...
// Share co-ordinates with other users 
// 1. Have client emit "sendLocation" with an object as the data 
// - Object should contain latitiude and longitude properties 
...
// server (emit) -> client (receive) --acknowledgement --> server --> server
